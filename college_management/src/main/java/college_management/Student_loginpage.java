...
/**
 * Servlet implementation class Student_loginpage
 */
@WebServlet("/Student_loginpage")
public class Student_loginpage extends HttpServlet {
		...
		if(i==1)
		{
		 ...
		 PrintWriter out=response.getWriter();
	       out.print("<!DOCTYPE html>\r\n"
	       		...
	       		+ "                  </table>\r\n"
	       		+ "      			 <div class=\"vmark\"> \r\n"
	       		+ "      			 <a href=\"Student_login_mark\">View Marks</a> \r\n"
	       		+ "      			</div> \r\n"
	       		+ "                 </div>\r\n"
	       		+ "            </div>\r\n"
	       		+ "        </div>\r\n"
