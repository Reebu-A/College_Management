	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		DBoperations db=new DBoperations();
		 List n=new ArrayList();   
	      ...
	      int teid= (int) n.get(9);
	      System.out.println("teid sp="+teid);
	      if(teid==0)
	      {
	    	  link="Admin_login";
	      }
		...
		PrintWriter out=response.getWriter();
	       out.print("<!DOCTYPE html>\r\n"
	       		...
	       		+ "    <link rel=\"stylesheet\" href=\"student_marklist.css\">\r\n"
	       		...
	       		+ "\r\n"
	       		+ "             <h2>"+n.get(3)+"</h2> \r\n"
	       		+ "             <a href=\"Enter_marks?sid="+sid+"\">Update Marks</a>\r\n"
	       		+ "            <a href=\"Students_details\">Students Details</a> \r\n"
	       		+ "            <a href=\" "+link+"\">Home</a>  \r\n"
	       		+ "          </div>\r\n"
	       		+ "         \r\n"
	       		+ "\r\n"
