...
/**
 * Servlet implementation class Students_details
 */
@WebServlet("/Students_details")
public class Students_details extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String lid=request.getParameter("idn");
		...
		out.print("<head>");
		   ...
		   out.print(" <meta name='viewport' content='width=device-width, initial-scale=1.0'>");
		    ...
		    out.print("<title>Student_Details</title>");
		out.print("</head>");
		out.print("<body>");
		    out.print("<div class='main'>");
		        ...
		        out.print("<div class='table-responsive-sm'>");
		            out.print("<table class='table table-striped table-bordered border-primary'>");
		                out.print("<thead>");
		                    out.print("<tr>");
		                  ...
		                  try 
		                  {
		         			...
		         			while(rs.next())
		         			{
		         				 out.print("<tr>");
			                        ...
			                        out.print("  <td><a href='Student_Profile?id="+rs.getInt("slno")+"'><button>View</button></a> <a href='Delete_Student?id="+rs.getInt("slno")+"'><button>Delete</button></a> </td>");
			                        out.print("</tr>");
